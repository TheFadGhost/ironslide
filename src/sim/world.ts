...
export function createPhysicsWorld(): CANNON.World {
  ...
  const slots = world as unknown as { ironslideMaterials?: { chassisMat: CANNON.Material; worldMat: CANNON.Material } };
  slots.ironslideMaterials = { chassisMat, worldMat };
  return world;
}

export function worldMaterials(world: CANNON.World): { chassisMat: CANNON.Material; worldMat: CANNON.Material } {
  const m = (world as unknown as { ironslideMaterials?: { chassisMat: CANNON.Material; worldMat: CANNON.Material } })
    .ironslideMaterials;
